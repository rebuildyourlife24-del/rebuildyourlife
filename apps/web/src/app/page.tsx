...
export default function CinematicLandingPage() {
  ...
  return (
    <div className="relative min-h-screen text-white font-sans bg-transparent selection:bg-blue-500/30">
      ...
      <div ref={contentRef} className="relative z-10">
        ...
        <section className="h-screen flex flex-col justify-center items-center text-center px-6">
          <div className="reveal">
            <div className="text-[10px] tracking-[0.4em] uppercase text-blue-400 mb-6 drop-shadow-[0_0_10px_rgba(6,182,212,0.8)]">
            ...
            <Link 
              href="/auth/login"
              className="group relative inline-block px-8 py-4 bg-transparent border border-white/20 overflow-hidden transition-all hover:border-blue-400"
            >
              <div className="absolute inset-0 w-0 bg-blue-400 transition-all duration-500 ease-out group-hover:w-full -z-10"></div>
        ...
        <section className="h-[50vh] flex items-center justify-center border-t border-white/10 bg-black/40 backdrop-blur-lg mt-32">
          <div className="text-center reveal">
            ...
            <Link href="/auth/login" className="text-blue-400 text-sm font-bold tracking-[0.2em] uppercase hover:text-white transition-colors">
              Access Dashboard →
            </Link>
          </div>
        </section>
