  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center p-8 text-center h-full">
      <div className="glass-panel p-12 max-w-lg w-full flex flex-col items-center gap-6 rounded-2xl relative overflow-hidden group">
        ...
        <h1 className="text-2xl font-bold uppercase tracking-widest text-white relative z-10">Kluis Module</h1>
        <p className="text-zinc-400 text-sm font-mono max-w-sm relative z-10">
          De Epistemic Engine is bezig met het kalibreren van de Kluis. Toegang vereist geverifieerde Executive-klaring.
        </p>
