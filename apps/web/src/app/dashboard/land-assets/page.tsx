                  ...
                  <tbody className="text-sm font-mono text-white/80">
                    <tr className="border-b border-zinc-800/50 hover:bg-zinc-900/50 transition-colors">
                      <td className="p-4 font-bold text-white flex items-center gap-2">
                        <MapPin className="w-4 h-4 text-emerald-400" /> Perceel 89 (Weesgrond)
                      </td>
                    ...
                    <tr className="border-b border-zinc-800/50 hover:bg-zinc-900/50 transition-colors">
                      ...
                      <td className="p-4"><span className="text-emerald-400Light bg-[#0a192f]/10 px-2 py-1 rounded text-[10px]">TAX_LIEN</span></td>
