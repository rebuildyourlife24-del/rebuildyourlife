...
import { CinematicDataSync } from '@/components/ui/CinematicDataSync';
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
            <div>
              ...
              <h1 className="text-5xl md:text-7xl font-black text-white tracking-tighter uppercase leading-[0.9]">
                System <br/><span className="text-transparent bg-clip-text bg-gradient-to-r from-zinc-100 to-zinc-600">Initialized</span>
              </h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <motion.div variants={itemVariants} className="lg:col-span-8">
          <div className="h-full bg-[#050505] border border-white/10 rounded-[2rem] p-8 relative overflow-hidden group hover:border-white/20 transition-colors shadow-xl">
             ...
             <div className="bg-black/80 backdrop-blur-3xl rounded-[2rem] border border-white/5 p-8 md:p-10 flex flex-col md:flex-row items-center gap-8 relative overflow-hidden group/card hover:border-emerald-500/30 transition-all duration-700 shadow-[0_0_0_rgba(6,182,212,0)] hover:shadow-[0_0_40px_rgba(6,182,212,0.15)]">
                ...
                <div className="absolute left-0 top-0 bottom-0 w-[2px] bg-emerald-500 shadow-[0_0_15px_rgba(6,182,212,0.5)] scale-y-0 group-hover/card:scale-y-100 transition-transform duration-500 origin-top"></div>
                
                {hasSynced ? (
                  <>
                    <div className="flex-1 relative z-10">
                      <h4 className="text-3xl font-black text-white tracking-tight mb-2">Data Stream Active</h4>
                    ...
                    <div className="w-32 h-32 rounded-full border border-emerald-500/30 flex items-center justify-center bg-emerald-500/10 shrink-0 relative z-10 shadow-[0_0_30px_rgba(6,182,212,0.2)]">
                    ...
                    <div className="flex-1 relative z-10">
                      ...
                      <div className="flex items-center gap-6">
                        <Button 
                          ...
                          className="bg-white hover:bg-emerald-500 hover:text-white text-black font-black uppercase tracking-widest px-8 py-6 rounded-full shadow-[0_0_20px_rgba(255,255,255,0.2)] hover:shadow-[0_0_30px_rgba(6,182,212,0.4)] transition-all duration-500 transform group-hover/card:scale-105"
                        >
                          Connect Now
                        </Button>
                        <span className="text-[10px] text-zinc-500 font-mono uppercase tracking-widest">Time est: 2 mins</span>
                      </div>
                    </div>

                    <div className="w-32 h-32 rounded-full border border-white/5 flex items-center justify-center bg-black/50 shrink-0 relative z-10 group-hover/card:border-emerald-500/20 transition-colors duration-700">
                      <div className="absolute inset-0 rounded-full bg-emerald-500/5 blur-xl opacity-0 group-hover/card:opacity-100 transition-opacity duration-1000"></div>
                      <Lock className="w-12 h-12 text-zinc-500 group-hover/card:text-emerald-400 transition-colors duration-500" />
                    </div>
                  </>
                )}
             </div>
