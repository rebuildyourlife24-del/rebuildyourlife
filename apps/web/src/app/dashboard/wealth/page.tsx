      ...
      <motion.div variants={itemVariants} className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4 border-b border-[#1f2937] pb-6">
        <div>
          <div className="flex items-center gap-3 mb-2">
            <h1 className="text-3xl md:text-5xl font-black text-white tracking-tight uppercase">Omega <span className="text-emerald-400">Web Builder</span></h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <motion.div variants={itemVariants}>
            <Card className="p-8 bg-[#0a0e1a] border border-emerald-500/30 shadow-[0_0_50px_rgba(212,168,83,0.1)] relative overflow-hidden">
              ...
              <form action={async (formData) => {
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                  <div className="bg-[#111827] p-4 rounded-xl border border-[#1f2937]">
                    ...
                    <input type="text" name="domain" placeholder="shop1.ai-henksemler.nl" className="w-full bg-black text-white font-mono p-2 rounded border border-zinc-800 focus:border-emerald-500 outline-none" required />
                  </div>
                  <div className="bg-[#111827] p-4 rounded-xl border border-[#1f2937]">
                    <label className="text-xs text-textSecondary uppercase font-bold mb-2 block">Franchise Naam</label>
                    <input type="text" name="name" placeholder="E-Commerce Niche A" className="w-full bg-black text-white font-mono p-2 rounded border border-zinc-800 focus:border-emerald-500 outline-none" required />
                  </div>
                </div>
                ...
                <Button 
                  ...
                  className="w-full bg-emerald-500 hover:bg-[#b0893a] text-black font-black uppercase tracking-[0.2em] py-6 text-lg shadow-[0_0_20px_rgba(212,168,83,0.4)] transition-all"
                >
                  {isGenerating ? (
          ...
          <motion.div variants={itemVariants}>
            <Card className="p-8 bg-black border-2 border-navyLight shadow-[inset_0_0_30px_rgba(153,27,27,0.2)] relative overflow-hidden">
              <div className="absolute top-0 right-0 p-8 opacity-5">
                <svg width="200" height="200" viewBox="0 0 24 24" fill="none" stroke="#06b6d4" strokeWidth="1"><path d="M12 2v20M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>
              </div>
              ...
              <div className="flex items-center gap-3 mb-6 relative z-10">
                ...
                <div>
                  <h2 className="text-xl font-black text-white uppercase tracking-widest flex items-center gap-2">
                    Shopify API Assimilatie <Badge variant="destructive" className="bg-emerald-500 text-[10px] animate-pulse">FASE 1.5</Badge>
                  </h2>
                  <p className="text-xs text-emerald-400/80 font-mono">Verbind de kassa en kanalen van externe Shopify winkels aan de War Room.</p>
                </div>
              </div>
              ...
              <form action={async (formData) => {
                ...
                <div className="bg-[#050505] p-4 border border-navyLight/50 mb-4 font-mono text-xs text-zinc-400">
                  <span className="text-emerald-400 font-bold">&gt; INSTRUCTIE:</span> Ga naar Shopify Dashboard &gt; Settings &gt; Apps &gt; Develop Apps. Maak een app genaamd "Orion Godbrain", geef Read/Write access op Orders en Products. Kopieer de "Admin API access token". (begint met <span className="text-white">shpat_</span>).
                </div>
                
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                  <div className="bg-black p-4 border-b-2 border-navyLight">
                    <label className="text-[10px] text-emerald-400 uppercase font-black tracking-widest mb-2 block">Shopify URL (bijv. shop.myshopify.com)</label>
                    <input type="text" name="shopUrl" placeholder="jouw-winkel.myshopify.com" className="w-full bg-transparent text-white font-mono p-2 border border-zinc-800 focus:border-emerald-500 outline-none" required />
                  </div>
                  <div className="bg-black p-4 border-b-2 border-navyLight">
                    <label className="text-[10px] text-emerald-400 uppercase font-black tracking-widest mb-2 block">Admin API Toegangstoken (shpat_...)</label>
                    <input type="password" name="accessToken" placeholder="shpat_xxxxxxxxxxxxxxxxxxxx" className="w-full bg-transparent text-emerald-400Light font-mono p-2 border border-zinc-800 focus:border-emerald-500 outline-none" required />
                  </div>
                </div>
                ...
                <Button 
                  type="submit"
                  disabled={isGenerating}
                  className="w-full bg-[#0a192f] hover:bg-navyLight text-emerald-400 border border-navyLight font-black uppercase tracking-[0.3em] py-6 text-lg transition-all"
                >
                  {isGenerating ? (
                    "ASSIMILATIE BEZIG..."
                  ) : (
          ...
          <motion.div variants={itemVariants}>
            <Card className="p-6 bg-[#050505] border border-[#06b6d4]/30 relative overflow-hidden">
               <div className="flex items-center justify-between mb-6">
                 <div className="flex items-center gap-3">
                   <PlaySquare className="w-6 h-6 text-[#06b6d4]" />
                   <h3 className="text-lg font-bold text-white uppercase tracking-widest">PR Sector (Content Forge)</h3>
                 </div>
                 <Badge variant="danger" className="bg-[#06b6d4]/10 border-[#06b6d4]/30">LIVE TRAFFIC ENGINE</Badge>
               </div>
            ...
            <div className="space-y-3 flex-1">
              <div className="p-3 bg-[#111827] border border-[#1f2937] rounded flex items-center justify-between cursor-pointer hover:border-[#3b82f6]/50 transition-colors">
                <div className="flex items-center gap-2">
                  <PlaySquare className="w-4 h-4 text-[#06b6d4]" />
