...
import { Target, CheckCircle2, CircleDashed, AlertTriangle, Play, Bot } from "lucide-react";
...
export default function TasksClient({ activeTasks }: { activeTasks: any[] }) {
  const failedEvents = [
          ...
          >
            <div className="space-y-4">
              {activeTasks.length > 0 ? activeTasks.map(task => {
                ...
                <div className="p-4 text-center text-muted-foreground">Geen actieve taken.</div>
              )}
            </div>
          </WidgetBase>
