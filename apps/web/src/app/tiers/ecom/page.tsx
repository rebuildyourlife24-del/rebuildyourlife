...
export default function TierEcomPage() {
  return (
    <div className="min-h-screen bg-[#050505] text-white selection:bg-[#ff003c]/30 selection:text-white font-sans overflow-x-hidden relative flex flex-col">
      ...
      <main className="flex-1 w-full max-w-[1400px] mx-auto px-6 md:px-12 py-12 md:py-24">
        ...
        >
          <span className="block text-transparent stroke-text-white">DOMINEER</span>
          <span className="block text-[#ff003c]">E-COMMERCE.</span>
        </motion.h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-start">
          ...
          >
            <p className="text-xl md:text-3xl font-medium text-zinc-400 leading-relaxed mb-8 border-l-4 border-[#ff003c] pl-6">
              Geen theorie. Keiharde inzet. Wij helpen jou met het bouwen en opschalen van winstgevende e-commerce systemen.
            </p>
            <ul className="space-y-4 mb-12">
              {[
                'Directe hulp en inzet bij je e-com winkel',
                'Toegang tot winnende product-strategieën',
                'Autonome AI copy & ads protocollen',
                'Begeleiding door The Syndicate'
              ].map((item, i) => (
          ...
          >
            ...
            <div className="relative z-10">
              <div className="text-[#ff003c] font-black text-6xl md:text-7xl tracking-tighter mb-2">€50<span className="text-2xl text-zinc-500">/mnd</span></div>
