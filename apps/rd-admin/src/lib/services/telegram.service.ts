export class TelegramService {
  ...
  /**
   * Send a specific request for approval (e.g. for SEO).
   */
  static async sendApprovalRequest(title: string, description: string) {
    const message = `🛡️ *SEO Agent Proposal*\n\n*${title}*\n${description}\n\n👉 Check the R&D admin dashboard to approve or deny.`;
